    ...
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Button size="lg" asChild className="bg-[image:linear-gradient(to_right,#7a5800,#f1c100,#7a5800)] hover:brightness-110 text-white font-bold border-none shadow-[0_1px_3px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.2)] hover:shadow-[0_2px_8px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.25)]">
